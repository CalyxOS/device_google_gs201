...
BOARD_VENDOR_KERNEL_RAMDISK_KERNEL_MODULES_LOAD_FILE := $(strip $(shell cat $(KERNEL_MODULE_DIR)/vendor_ramdisk/lib/modules/modules.load))
...
include device/google/gs201/BoardConfig-calyx.mk
